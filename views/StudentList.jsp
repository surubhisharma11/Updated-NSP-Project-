		...
		<c:forEach items="${studList}" var="list">
			<tr>
				...
				<td><input class="button" type="submit"
					...
					onclick="window.location.href='approveApplication/${list.applicationId}/Approved'"></td>
				<td><input class="button" type="submit" value="Reject"
					onclick="window.location.href='approveApplication/${list.applicationId}/Rejected'"></td>
			</tr>
		</c:forEach>
	</table><br><br><br>
	<a href="homePage">Click to go to Home Page</a></center>
</body>
</html>