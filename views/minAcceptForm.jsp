...
<title>Ministry View Page</title>
	...
	<center>
		...
		<input class="button" type="submit" id="print"
			value="Print Regsitration Form" onclick="printData()"> 
			 <input class="button" type="submit" id="goHome"
			value="Go Back to Home Page"
			onclick="window.location.href='homePage'"> <br> <br>
			<td><input class="button" type="submit" value="Go back"
		onclick="window.location.href='getStuApplList'"></td>
