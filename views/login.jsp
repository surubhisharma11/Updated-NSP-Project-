...
<head>
    ...
    <title>State Nodal Officer Login Page</title>
    <style>
  ...
  <h1>NATIONAL SCHOLARSHIP PORTAL</h1>
    ...
    <H3>Government Of India</H3>
           ...
           <form class="login-form">
            ...
            State Nodal Officer</span>
            </p>
            <input type="text" class="login-username" autofocus="true" required="true" name="username" placeholder="Nodal Officer ID" />
