...
<head>
    ...
    <title>Institute Login Page</title>
  ...
  <div class="header">
    <h1>NATIONAL SCHOLARSHIP PORTAL</h1>
      ...
      <H3>Government Of India</H3>
            ...
            <img class="nt" src="${pageContext.request.contextPath}/resources/images/nt.jpg" alt="nt">
           ...
           <form class="login-form">
            ...
            <p class="login-text">
              ...
              Institute Login</span>
            </p>
            <input type="text" class="login-username" autofocus="true" required="true" name="instituteCode" placeholder="Institute ID" />
            <input type="password" class="login-password" required="true" name="psw"  placeholder="Password" />
...
<!--                                    <p style="font-weight: bold;"><span class="fa fa-android" style="color: #df534f;">&nbsp;<strong>Mobile App for NSP 2.0</strong> is now available. App can be downloaded from Google Play Store. </span></p>-->
                ...
                <div class="footer">
                      ...
                      <p class="note">Those Institutes does not have Login Credentials can contact <br>District / State Nodal Officers for Login Credentials.</p>  
